...
![Fi-lguvpG_yCUWav8wIsw6lfvoYp.png](https://cdn.bedelightful.ai/static/img/Fi-lguvpG_yCUWav8wIsw6lfvoYp.png)

## II. Configure Microsoft Azure Service Provider
#### 2.1 Enter API Address

![FkV9KpWFwEU56B88zPK7nwdUeYil.png](https://cdn.bedelightful.ai/static/img/FkV9KpWFwEU56B88zPK7nwdUeYil.png)

## III. Configure ByteDance Service Provider
#### 3.1 API Address:
[https://ark.cn-beijing.volces.com/](https://ark.cn-beijing.volces.com/)

![FioaPOfC3oc0bGaaWq78sgyd7_i1.png](https://cdn.bedelightful.ai/static/img/FioaPOfC3oc0bGaaWq78sgyd7_i1.png)

#### 3.2 Model Name

![Fn2GBfAUgc4AkK5SiGbmYj3x8kgj.png](https://cdn.bedelightful.ai/static/img/Fn2GBfAUgc4AkK5SiGbmYj3x8kgj.png)

## IV. Configure Custom Service Provider (Supports OpenAI API Format)
#### 4.1 Add Custom Service Provider

![FvKLaK0LaSNSMYsVLDmpRBGbJ7Ad.png](https://cdn.bedelightful.ai/static/img/FvKLaK0LaSNSMYsVLDmpRBGbJ7Ad.png)
...
![FtB1mFoFCiL3kAaqBh0x8yAYnBw8.png](https://cdn.bedelightful.ai/static/img/FtB1mFoFCiL3kAaqBh0x8yAYnBw8.png)

#### 4.3 Add Corresponding Models

![Fnf25GBXzCb_gnS1DtLSDLJOk-LR.png](https://cdn.bedelightful.ai/static/img/Fnf25GBXzCb_gnS1DtLSDLJOk-LR.png)
...
![FsqFvaxlu7MiQB7Jg8zsgmlyBoeU.png](https://cdn.bedelightful.ai/static/img/FsqFvaxlu7MiQB7Jg8zsgmlyBoeU.png)

- 5.3 Initiate debugging. If the model is not activated, you will be required to activate it and authorize an API Key

![FrLzQgYd-R0cPuh-grhOffzgNyLR.png](https://cdn.bedelightful.ai/static/img/FrLzQgYd-R0cPuh-grhOffzgNyLR.png)
