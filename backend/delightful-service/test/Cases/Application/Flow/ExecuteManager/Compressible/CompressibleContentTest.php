...
class CompressibleContentTest extends ExecuteManagerBaseTest
{
    ...
    {
        $content = '1.whenIstrollinthis园middle,Ideeplybodywillto,eachonelocationplaceallonce leftdownIfootprint,whilethattheseplacealsoallhavepassmother accompanied.<DelightfulCompressibleContent Type="Image">firstneedbecompressdata</DelightfulCompressibleContent> 2.ifbyonedaymetaphorfourseason,morningisspringday,middlenoonissummerday,duskisautumnday,nighttheniswinterday.\n!\n<DelightfulCompressibleContent Type="Video">thetwoneedbecompressdata</DelightfulCompressibleContent>3.toosuneacho clockeachmomentallisfalldayand旭day,whenhesunseto clock,justishecrawlupmountainheadofo clock.whileI,finalwillcalmgroundwalkdownmountaingo.';
    ...
    public function testRun1()
    {
        ...
        $compressibleContent = CompressibleContent::compress($content);
        $this->assertEquals('1.whenIstrollinthis园middle,Ideeplybodywillto,eachonelocationplaceallonce leftdownIfootprint,whilethattheseplacealsoallhavepassmother accompanied.firstneedbecompressdata 2.ifbyonedaymetaphorfourseason,morningisspringday,middlenoonissummerday,duskisautumnday,nighttheniswinterday.\n!\nthetwoneedbecompressdata3.toosuneacho clockeachmomentallisfalldayand旭day,whenhesunseto clock,justishecrawlupmountainheadofo clock.whileI,finalwillcalmgroundwalkdownmountaingo.', CompressibleContent::deCompress($compressibleContent, false));
    }

    public function testRun2()
    {
        $content = '1.whenIstrollinthis园middle,Ideeplybodywillto,eachonelocationplaceallonce leftdownIfootprint,whilethattheseplacealsoallhavepassmother accompanied.<DELIGHTFUL-COMPRESSABLE-CONTENT TYPE="PICTURE">firstneedbecompressdata</DELIGHTFUL-COMPRESSABLE-CONTENT> 2.ifbyonedaymetaphorfourseason,morningisspringday,middlenoonissummerday,duskisautumnday,nighttheniswinterday.\n!\n<DELIGHTFUL-COMPRESSABLE-CONTENT TYPE="PICTURE">thetwoneedbecompressdata</DELIGHTFUL-COMPRESSABLE-CONTENT>3.toosuneacho clockeachmomentallisfalldayand旭day,whenhesunseto clock,justishecrawlupmountainheadofo clock.whileI,finalwillcalmgroundwalkdownmountaingo.';
