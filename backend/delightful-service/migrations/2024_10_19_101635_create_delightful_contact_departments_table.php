...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_contact_departments', static function (Blueprint $table) {
            ...
            $table->string('order', 64)->comment('department的sort，即departmentin其同级department的展示顺序。取valuemore小sortmore靠前。')->nullable()->default('');
            ...
            $table->text('status')->comment('departmentstatus,jsonformat,目前support is_deleted:whetherdelete');
