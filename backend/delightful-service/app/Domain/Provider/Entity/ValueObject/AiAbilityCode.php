...
enum AiAbilityCode: string
{
    ...
    case SmartRename = 'smart_rename';                     // 智能rename
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::SmartRename => '本能力覆盖平台所havesupport AI renameapplication场景，according to理解updown文foruserfrom动conductcontenttitle命名。',
