...
/** * UpdateItemMemberRequestDTO. * * UpdateItemMemberRequestParameterValidate * InheritanceAbstractRequestDTOautomatic SupportParameterValidate TypeConvert */

class UpdateProjectMembersRequestDTO extends AbstractRequestDTO 
{
 /** @var string Project IDroute Parameter */ 
    private string $projectId = ''; /** @var array MemberDatalist */ 
...
{
 return [ 'members' => 'nullable|array|min:0|max:500', 'members.*.target_type' => 'required|string|in:user ,Department', 'members.*.target_id' => 'required|string|max:128', ]; 
}
