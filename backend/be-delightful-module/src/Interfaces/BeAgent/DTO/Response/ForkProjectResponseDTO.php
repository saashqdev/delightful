...
{
 return new self( status: $projectFork->getStatus()->value, recordId: (string) $projectFork->getId(), projectId: (string) $projectFork->getForkProjectId(), ); 
}
 
    public function toArray(): array 
{
 return [ 'status' => $this->status, 'project_id' => $this->projectId, 'record_id' => $this->recordId, ]; 
}
