...
<head>
  ...
  <title>ECharts Simple Chart Example</title>
  <style>
    body {
      margin: 0;
      padding: 0;
...
<body>
  <div class="container">
    <h2 class="title">Data Visualization Demo</h2>
    <div class="controls">
      <button id="barChart">Bar Chart</button>
      <button id="lineChart">Line Chart</button>
      <button id="pieChart">Pie Chart</button>
    </div>
