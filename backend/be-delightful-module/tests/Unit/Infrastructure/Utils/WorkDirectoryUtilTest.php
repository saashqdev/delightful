...
namespace Delightful\SuperMagic\Tests\Unit\Infrastructure\Utils;
...
class WorkDirectoryUtilTest extends TestCase
{
    public function testIsValidWorkDirectory(): void
    {
        ...
        $path = '/some/path/SUPER_DELIGHTFUL/user123/project_456';
        ...
        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            '/some/path/SUPER_DELIGHTFUL/user123/project_456/workspace',
            $userId
        ));

        // Test relative path - legacy format
        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            'SUPER_DELIGHTFUL/user123/project_789',
            $userId
        ));

        // Test relative path - new format
        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            'SUPER_DELIGHTFUL/user123/project_789/workspace',
            $userId
        ));

        // Test with trailing slash - legacy format
        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            '/some/path/SUPER_DELIGHTFUL/user123/project_456/',
            $userId
        ));
        ...
        $this->assertFalse(WorkDirectoryUtil::isValidWorkDirectory('/some/path/SUPER_DELIGHTFUL/wronguser/project_456', $userId));
        $this->assertFalse(WorkDirectoryUtil::isValidWorkDirectory('/some/path/SUPER_DELIGHTFUL/user123/project_abc', $userId));
        $this->assertFalse(WorkDirectoryUtil::isValidWorkDirectory('/some/path/SUPER_DELIGHTFUL/user123/project_456/invalid_suffix', $userId));
        $this->assertFalse(WorkDirectoryUtil::isValidWorkDirectory('/some/path/SUPER_DELIGHTFUL/user123/wrongformat', $userId));
    }
    ...
    public function testExtractProjectIdFromAbsolutePath(): void
    {
        ...
        // Test relative path - legacy format
        $path = 'SUPER_DELIGHTFUL/user123/project_789';
        ...
        $this->assertEquals('123456789', WorkDirectoryUtil::extractProjectIdFromAbsolutePathLegacy(
            '/some/path/SUPER_DELIGHTFUL/user123/project_123456789/workspace',
            $userId
        ));
        ...
        $this->assertNull(WorkDirectoryUtil::extractProjectIdFromAbsolutePathLegacy('/some/path/SUPER_DELIGHTFUL/wronguser/project_456', $userId));
        $this->assertNull(WorkDirectoryUtil::extractProjectIdFromAbsolutePathLegacy('/some/path/SUPER_DELIGHTFUL/user123/project_abc', $userId));
        $this->assertNull(WorkDirectoryUtil::extractProjectIdFromAbsolutePathLegacy('/some/path/SUPER_DELIGHTFUL/user123/project_456/invalid_suffix', $userId));
        $this->assertNull(WorkDirectoryUtil::extractProjectIdFromAbsolutePathLegacy('/some/path/SUPER_DELIGHTFUL/user123/wrongformat', $userId));
    }
    ...
    public function testEdgeCases(): void
    {
        ...
        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            '/SUPER_DELIGHTFUL/user_with_special-chars.123/project_999',
            $userId
        ));

        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            '/SUPER_DELIGHTFUL/user_with_special-chars.123/project_999/workspace',
            $userId
        ));
        ...
        $this->assertTrue(WorkDirectoryUtil::isValidWorkDirectory(
            '/SUPER_DELIGHTFUL/user123/project_0/workspace',
            'user123'
        ));
