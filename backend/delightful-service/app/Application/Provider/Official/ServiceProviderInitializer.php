    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'Amazon Bedrock 是亚马逊 AWS 提供的一itemservice，专注at为企业提供先进的 AI 语言model和视觉model。其model家族include Anthropic 的 Claude 系column、Meta 的 Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance的多typechoose，support文本generate、conversation、graph像handleetc多typetask，适useatdifferent规模和需求的企业application。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Amazon Bedrock 是亚马逊 AWS 提供的一itemservice，专注at为企业提供先进的 AI 语言model和视觉model。其model家族include Anthropic 的 Claude 系column、Meta 的 Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance的多typechoose，support文本generate、conversation、graph像handleetc多typetask，适useatdifferent规模和需求的企业application。',
                    ],
                ]),
                'remark' => '',
            ],
