    ...
    private string $scriptName = '', ) 
{
 ...
 /** * CreateInterruptRequest */ 
    public 
    static function create(string $taskId, array $arguments, string $scriptName): self 
{
...
{
 return [ 'task_id' => $this->taskId, 'arguments' => $this->arguments, 'script_name' => $this->scriptName, ]; 
}
