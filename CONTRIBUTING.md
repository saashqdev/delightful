...
Looking for something to tackle?  Browse our [good first issues](https://github.com/saashqdev/delightful/delightful/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22) and pick one to get started!

Got a cool idea or feature to add?  Open a PR in our [main repo](https://github.com/saashqdev/delightful/delightful) and show us what you've built.

Need to update an existing feature or squash some bugs?  Open a PR in our [main repo](https://github.com/saashqdev/delightful/delightful) and make your delightful happen!
...
| Popular feature requests from our [community feedback board](https://github.com/saashqdev/delightful/delightful/discussions/categories/feedbacks) | Medium Priority |
...
For setting up the frontend service, please refer to our comprehensive [guide](https://github.com/saashqdev/delightful/delightful/blob/main/frontend/README.md) in the `frontend/README. md` file.  This document provides detailed instructions to help you set up the frontend environment properly.

#### Backend

For setting up the backend service, kindly refer to our detailed [instructions](https://github.com/saashqdev/delightful/delightful/blob/main/backend/README.md) in the `backend/README. md` file.  This document contains step-by-step guidance to help you get the backend up and running smoothly.
