...
namespace Delightful\BeDelightful\Interfaces\SuperAgent\Facade\InternalApi;
    ...
    protected RequestInterface $request, ) 
{
 ...
 /** * CreateFileVersion. * * @return array CreateResult */ 
    public function createFileVersion(): array 
{
 $requestDTO = CreateFileVersionRequestDTO::fromRequest($this->request); $responseDTO = $this->fileVersionAppService->createFileVersion($requestDTO); return $responseDTO->toArray(); 
}
