    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'name' => '火山engine',
                'provider_code' => 'Volcengine',
                'description' => '提供多type智能绘图大model，生图style多样，securityproperty极高，可亠泛application干教育、娱乐、办公etc场quantity。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供多type智能绘图大model，生图style多样，securityproperty极高，可亠泛application干教育、娱乐、办公etc场quantity。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '专注at人脸技术、人body技术、图像识别、图像handle、图像generateetc核core领域',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '专注at人脸技术、人body技术、图像识别、图像handle、图像generateetc核core领域',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Delightful',
                'provider_code' => 'Official',
                'description' => '由 Delightful pass官方deploy的 API 来implement多type热门的文生图、图生图etcmodel的call，可直接购买pointsuse海quantity的大model。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/delightful.png',
                'provider_type' => 1, // Official
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '由 Delightful pass官方deploy的 API 来implement多type热门的文生图、图生图etcmodel的call，可直接购买pointsuse海quantity的大model。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'Amazon Bedrock 是亚马逊 AWS 提供的一itemservice，专注at为企业提供先进的 AI 语言model和视觉model。其model家族include Anthropic 的 Claude 系column、Meta 的 Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance的多type选择，support文本generate、conversation、图像handleetc多typetask，适useatdifferent规模和需求的企业application。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Amazon Bedrock 是亚马逊 AWS 提供的一itemservice，专注at为企业提供先进的 AI 语言model和视觉model。其model家族include Anthropic 的 Claude 系column、Meta 的 Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance的多type选择，support文本generate、conversation、图像handleetc多typetask，适useatdifferent规模和需求的企业application。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => '提供通use图像generatemodel，support多type艺术style，particularly擅长复杂文本渲染，especially是middle英文文本渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供通use图像generatemodel，support多type艺术style，particularly擅长复杂文本渲染，especially是middle英文文本渲染。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '提供 Gemini 2.5 Flash Image (Nano Banana) 图像generatemodel，具备role一致property高、精准图像editetc。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供 Gemini 2.5 Flash Image (Nano Banana) 图像generatemodel，具备role一致property高、精准图像editetc。',
                    ],
                ]),
                'remark' => '',
            ],
