...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    public static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'fragment_config.normal.segment_rule.separator.required_if' => 'minutesegment标识符not能为空',
            ...
            'fragment_config.parent_child.separator.required_if' => 'minutesegment标识符not能为空',
            ...
            'fragment_config.parent_child.child_segment_rule.separator.required_if' => '子pieceminutesegment标识符not能为空',
            ...
            'fragment_config.parent_child.parent_segment_rule.separator.required_if' => '父pieceminutesegment标识符not能为空',
