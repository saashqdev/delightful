...
{
 $authorization = $this->getAuthorization(); $withtool Schema = (bool) $this->request->input('with_tool_schema', false); $entity = $this->BeDelightfulAgentAppService->show($authorization, $code, $withtool Schema); $withPromptString = (bool) $this->request->input('with_prompt_string', false); return BeDelightfulAgentAssembler::createDTO($entity, [], $withPromptString); 
}
 
    public function executetool () 
{
 $authorization = $this->getAuthorization(); $params = $this->request->all(); return $this->BeDelightfulAgentAppService->executetool ($authorization, $params); 
}
