...
import TopicIcon from "@/opensource/pages/beDelightful/components/TopicIcon"
import type { Thread, Workspace } from "@/opensource/pages/beDelightful/pages/Workspace/types"
			...
			>
				<div className={styles.popupContent}>
					<div className={styles.popupContentHeader}>
						<div className={styles.popupContentHeaderTitle}>Workspace</div>
