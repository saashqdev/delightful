...
# not如decrease \Hyperf\Snowflake\Configuration middle $dataCenterIdBits 和 $workerIdBits 的size,增大 $sequenceBits,by便单台机器each毫second能generatemore多的雪flowerid,decrease特高并hairdown的etc待time
return [
