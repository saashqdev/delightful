...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('service_provider_models_config_versions', function (Blueprint $table) {
            ...
            $table->integer('vector_size')->default(2048)->comment('to量维度');
            ...
            $table->boolean('support_deep_think')->default(false)->comment('whethersupport深度思考');
            $table->decimal('cache_write_pricing', 10, 4)->nullable()->comment('cachewrite定价');
            $table->boolean('support_multi_modal')->default(false)->comment('whethersupport多模态');
            $table->boolean('official_recommended')->default(false)->comment('whether官方推荐');
