...
return [
    'agent' => [
        ...
        'validation' => [
            ...
            'name_required' => 'Agent name cannot be empty',
            ...
            'icon_array' => 'Agent icon must be an array',
            'type_integer' => 'Agent type must be an integer',
            'type_invalid' => 'Agent type is invalid',
            'enabled_boolean' => 'Enabled status must be a boolean',
            'prompt_required' => 'Agent prompt cannot be empty',
            'prompt_array' => 'Agent prompt must be an array',
            'tools_array' => 'Tools configuration must be an array',

            // Tool field validation
            'tool_code_required' => 'Tool code cannot be empty',
            'tool_code_string' => 'Tool code must be a string',
            'tool_code_max' => 'Tool code cannot exceed 100 characters',
            'tool_name_required' => 'Tool name cannot be empty',
            ...
            'tool_type_required' => 'Tool type cannot be empty',
            'tool_type_integer' => 'Tool type must be an integer',
            'tool_type_invalid' => 'Tool type is invalid',
            ...
            'codes_array' => 'Code list must be an array',
            ...
            // Sorting validation
            'frequent_array' => 'Frequent agents sorting must be an array',
            ...
            'all_array' => 'All agents sorting must be an array',
            'all_code_string' => 'All agents code must be a string',
            'all_code_max' => 'All agents code cannot exceed 50 characters',
        ],
        'order' => [
            'frequent' => 'Frequent Agents',
            'all' => 'All Agents',
        ],
        'limit_exceeded' => 'Agent count has reached the limit (:limit), cannot create more',
        'builtin_not_allowed' => 'Built-in agents do not support this operation',
    ],
];
