            ...
            <<<'JSON'
{
    ...
    "properties": {
        ...
        "type": {
            ...
            "key": "type",
            "title": "重复period",
            "description": "重复period，no_repeat 不重复，daily_repeat 每天parameter，weekly_repeat 每周重复，monthly_repeat 每月重复，annually_repeat 每年重复，weekday_repeat 每个工作日重复，custom_repeat customize重复",
            "required": null,
            "value": null,
            "encryption": false,
            "encryption_value": null,
