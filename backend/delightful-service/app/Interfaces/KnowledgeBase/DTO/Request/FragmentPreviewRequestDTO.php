...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    public static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'fragment_config.normal.text_preprocess_rule.required_if' => '文本预process规则不能为空',
            'fragment_config.normal.text_preprocess_rule.*.required' => '预process规则项不能为空',
            'fragment_config.normal.text_preprocess_rule.*.integer' => '预process规则must是整数',
            'fragment_config.normal.text_preprocess_rule.*.in' => '预process规则must是 1(替换空格等) 或 2(deleteURL和邮箱)',
            ...
            'fragment_config.parent_child.text_preprocess_rule.required_if' => '文本预process规则不能为空',
            'fragment_config.parent_child.text_preprocess_rule.*.required' => '预process规则项不能为空',
            'fragment_config.parent_child.text_preprocess_rule.*.integer' => '预process规则must是整数',
            'fragment_config.parent_child.text_preprocess_rule.*.in' => '预process规则must是 1(替换空格等) 或 2(deleteURL和邮箱)',
        ];
    }
