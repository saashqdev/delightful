...
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-1.png)
...
1. Log in to the [Delightful](https://www.letsdelightful.cn/login) platform. (If using private deployment, log in to the corresponding private deployment platform)
...
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-2.png)

## 3. Orchestrate Workflow
### 1. Click to create "Start Node"
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-3.png)
...
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-4.png)
...
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-5.png)
...
```
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-6.png)
...
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-7.png)
...
![Translation Screenshot](https://cdn.letsdelightful.cn/static/img/Translation-assistant-8.png)
