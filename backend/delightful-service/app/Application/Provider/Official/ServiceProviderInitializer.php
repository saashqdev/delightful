    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'by Delightful pass官方deploy API comeimplement AI modelcall，can直接购买pointsuse海quantity大model。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'by Delightful pass官方deploy API comeimplement AI modelcall，can直接购买pointsuse海quantity大model。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'Azure provide多type先enterAImodel、includeGPT-3.5andmostnewGPT-4系column、support多typedatatypeand复杂task，致力atsecurity、can靠andcancontinueAIresolvesolution,',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Azure provide多type先enterAImodel、includeGPT-3.5andmostnewGPT-4系column、support多typedatatypeand复杂task，致力atsecurity、can靠andcancontinueAIresolvesolution,',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '字section跳动旗down云service平台，havefrom主研hair豆package大model系column。涵盖豆package通usemodel Pro、lite，具备differenttexthandleand综合can力，alsohaverole扮演、voice合becomeetc多typemodel。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '字section跳动旗down云service平台，havefrom主研hair豆package大model系column。涵盖豆package通usemodel Pro、lite，具备differenttexthandleand综合can力，alsohaverole扮演、voice合becomeetc多typemodel。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => '火山engine',
                'provider_code' => 'Volcengine',
                'description' => 'provide多type智can绘graph大model，生graphstyle多样，securityproperty极高，can亠泛application干教育、娱乐、办公etc场quantity。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'provide多type智can绘graph大model，生graphstyle多样，securityproperty极高，can亠泛application干教育、娱乐、办公etc场quantity。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Delightful',
                'provider_code' => 'Official',
                'description' => 'by Delightful pass官方deploy API comeimplement多type热门文生graph、graph生graphetcmodelcall，can直接购买pointsuse海quantity大model。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/delightful.png',
                'provider_type' => 1, // Official
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'by Delightful pass官方deploy API comeimplement多type热门文生graph、graph生graphetcmodelcall，can直接购买pointsuse海quantity大model。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'Amazon Bedrock is亚马逊 AWS provideoneitemservice，专注atfor企业provide先enter AI languagemodeland视觉model。itsmodel家族include Anthropic  Claude 系column、Meta  Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance多typechoose，supporttextgenerate、conversation、graphlikehandleetc多typetask，适useatdifferent规模and需求企业application。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Amazon Bedrock is亚马逊 AWS provideoneitemservice，专注atfor企业provide先enter AI languagemodeland视觉model。itsmodel家族include Anthropic  Claude 系column、Meta  Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance多typechoose，supporttextgenerate、conversation、graphlikehandleetc多typetask，适useatdifferent规模and需求企业application。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Microsoft Azure',
                'provider_code' => 'MicrosoftAzure',
                'description' => 'provide多type先enterAImodel、includeGPT-3.5andmostnewGPT-4系column、support多typedatatypeand复杂task，致力atsecurity、can靠andcancontinueAIresolvesolution。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/azure Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => 'provide通usegraphlikegeneratemodel，support多type艺术style，particularly擅长复杂text渲染，especiallyismiddleEnglishtext渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'provide通usegraphlikegeneratemodel，support多type艺术style，particularly擅长复杂text渲染，especiallyismiddleEnglishtext渲染。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'provide Gemini 2.5 Flash Image (Nano Banana) graphlikegeneratemodel，具备roleone致property高、精准graphlikeeditetc。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'provide Gemini 2.5 Flash Image (Nano Banana) graphlikegeneratemodel，具备roleone致property高、精准graphlikeeditetc。',
                    ],
                ]),
                'remark' => '',
            ],
