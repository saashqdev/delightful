...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_contact_third_platform_department_users', static function (Blueprint $table) {
            ...
            $table->string('third_country', 32)->comment('countryorground区 Code 缩写')->default('CN');
            ...
            $table->tinyInteger('third_employee_type')->comment('employeetype.1:justtypeemployee2:实习生3:outsidepackage4:劳务 5:consultant')->default(1);
