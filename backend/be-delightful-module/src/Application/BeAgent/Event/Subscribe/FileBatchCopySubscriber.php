...
use BeDelightful\BeDelightful\Domain\BeAgent\Event\FileBatchCopyEvent;
...
use BeDelightful\BeDelightful\Infrastructure\Utils\FileBatchOperationStatusManager;
use BeDelightful\BeDelightful\Infrastructure\Utils\FileTreeUtil;
 ...
 */
#[Consumer(
    exchange: 'be_delightful_file_batch_copy',
    routingKey: 'be_delightful_file_batch_copy',
    queue: 'be_delightful_file_batch_copy',
    nums: 1
)]
