...
class Settings(BaseSettings):
    ...
    # Sandbox image name
    be_delightful_image_name: str = Field(..., env="BE_DELIGHTFUL_IMAGE_NAME")
...
def load_settings() -> Settings:
    ...
    try:
        ...
        # If BE_DELIGHTFUL_IMAGE_NAME is not defined, it must be set manually
        be_delightful_image_name = os.environ.get("BE_DELIGHTFUL_IMAGE_NAME")
        if not be_delightful_image_name:
            raise ValueError("Environment variable BE_DELIGHTFUL_IMAGE_NAME must be set to specify sandbox image name") from e
        ...
        return Settings(be_delightful_image_name=be_delightful_image_name)
