...
/*
 * Create delightful_be_agent_project_fork table.
 */
return new class extends Migration {
    ...
    {
        Schema::create('delightful_be_agent_project_fork', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('delightful_be_agent_project_fork');
    }
};
