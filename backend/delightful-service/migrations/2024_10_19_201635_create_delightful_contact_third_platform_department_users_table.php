...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_contact_third_platform_department_users', static function (Blueprint $table) {
            ...
            $table->string('third_country', 32)->comment('国家or地区 Code 缩写')->default('CN');
            $table->string('third_join_time', 64)->comment('入职time。秒级time戳format，table示from 1970 年 1 月 1 日start所经过的秒数。');
