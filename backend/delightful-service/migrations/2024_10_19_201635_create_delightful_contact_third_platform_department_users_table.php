...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_contact_third_platform_department_users', static function (Blueprint $table) {
            ...
            $table->string('third_country', 32)->comment('countryorground区 Code abbreviation')->default('CN');
            $table->string('third_join_time', 64)->comment('入职time.secondleveltime戳format,table示from 1970 year 1 month 1 daystartpassed throughpasssecond数.');
            $table->string('third_employee_no', 32)->comment('工number')->default('');
            $table->tinyInteger('third_employee_type')->comment('employeetype.1:justtypeemployee2:intern3:outsidepackage4:劳务 5:consultant')->default(1);
