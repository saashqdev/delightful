...
JSON, true));
        ...
        $executionData->saveNodeContext('9527', [
            ...
            'user_prompt' => '帮我提取一下 https://example.tos-cn-beijing.volces.com/DELIGHTFUL/test/出师表.txt 和 https://example.tos-cn-beijing.volces.com/DELIGHTFUL/test/测试.csv 的内容',
        ]);
