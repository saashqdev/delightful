...
JSON, true));
        ...
        $executionData->saveNodeContext('9527', [
            ...
            'content' => 'Q: 我为什么要在述职准备上花time？ A: 假设你本身的工作产出是90分，一个好的述职呈现能将你这 90 分的工作完美地呈现给所有人，但一个在content结构、validinfo量和可读性上都不尽如人意的 PPT 可能只能呈现出你30分的工作成果。 并且，如果你在述职的表达与呈现方面做得很不尽如人意、没有体现出结构化的思考方式、没有 SMART 的未来规划，那么同样的，你在日常departmentwill议中的沟通协作能力、工作中的逻辑思维能力、自我管理和规划的能力也will备受质疑。 述职往往是一个人日常为人处事态度的良好影射，优秀的人往往不吝于向公众展示自己的成果，这也是为什么像 GitHub 这样的开源社区will存在，且汇聚了大量的优秀人才。 同时，述职也是一个非常珍贵的、让你有机will了解其它人在做什么的场域。',
            'business_id' => '',
        ]);
        $runner->execute($vertexResult, $executionData, []);
        $this->assertTrue($node->getNodeDebugResult()->isSuccess());
