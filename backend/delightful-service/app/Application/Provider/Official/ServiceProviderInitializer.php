    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'Azure 提供多type先进的AImodel、includeGPT-3.5和mostnewGPT-4系column、support多typedatatype和复杂task，致力atsecurity、可靠和可continue的AIresolvesolution,',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Azure 提供多type先进的AImodel、includeGPT-3.5和mostnewGPT-4系column、support多typedatatype和复杂task，致力atsecurity、可靠和可continue的AIresolvesolution,',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '字section跳动旗down的云service平台，have自主研hair的豆package大model系column。涵盖豆package通usemodel Pro、lite，具备differenttexthandle和综合能力，alsohaverole扮演、voice合becomeetc多typemodel。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '字section跳动旗down的云service平台，have自主研hair的豆package大model系column。涵盖豆package通usemodel Pro、lite，具备differenttexthandle和综合能力，alsohaverole扮演、voice合becomeetc多typemodel。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '专注atperson脸技术、personbody技术、graph像识别、graph像handle、graph像generateetc核core领域',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '专注atperson脸技术、personbody技术、graph像识别、graph像handle、graph像generateetc核core领域',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'Amazon Bedrock 是亚马逊 AWS 提供的一itemservice，专注at为企业提供先进的 AI languagemodel和视觉model。其model家族include Anthropic 的 Claude 系column、Meta 的 Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance的多typechoose，supporttextgenerate、conversation、graph像handleetc多typetask，适useatdifferent规模和需求的企业application。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Amazon Bedrock 是亚马逊 AWS 提供的一itemservice，专注at为企业提供先进的 AI languagemodel和视觉model。其model家族include Anthropic 的 Claude 系column、Meta 的 Llama 3.1 系columnetc，涵盖from轻quantitylevelto高performance的多typechoose，supporttextgenerate、conversation、graph像handleetc多typetask，适useatdifferent规模和需求的企业application。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Microsoft Azure',
                'provider_code' => 'MicrosoftAzure',
                'description' => '提供多type先进的AImodel、includeGPT-3.5和mostnewGPT-4系column、support多typedatatype和复杂task，致力atsecurity、可靠和可continue的AIresolvesolution。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/azure Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => '提供通usegraph像generatemodel，support多type艺术style，particularly擅长复杂text渲染，especially是middleEnglishtext渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供通usegraph像generatemodel，support多type艺术style，particularly擅长复杂text渲染，especially是middleEnglishtext渲染。',
                    ],
                ]),
                'remark' => '',
            ],
