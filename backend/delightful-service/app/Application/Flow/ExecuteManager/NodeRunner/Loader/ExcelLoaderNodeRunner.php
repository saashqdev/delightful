...
#[FlowNodeDefine(type: NodeType::ExcelLoader->value, code: NodeType::ExcelLoader->name, name: '电子表格parse', paramsConfig: ExcelLoaderNodeParamsConfig::class, version: 'v0', singleDebug: true, needInput: false, needOutput: true)]
class ExcelLoaderNodeRunner extends NodeRunner
{
    protected function run(VertexResult $vertexResult, ExecutionData $executionData, array $frontResults): void
    {
        ...
        foreach ($files as $file) {
            ...
            // according to链接getfiletype，这里只get后缀可能不准确
