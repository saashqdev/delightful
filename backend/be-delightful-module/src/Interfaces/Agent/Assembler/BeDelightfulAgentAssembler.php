...
use Delightful\BeDelightful\Interfaces\Agent\DTO\BeDelightfulAgentCategorizedListDTO;
use Delightful\BeDelightful\Interfaces\Agent\DTO\BeDelightfulAgentDTO;
use Delightful\BeDelightful\Interfaces\Agent\DTO\BeDelightfulAgentListDTO;
...
class BeDelightfulAgentAssembler
{
    ...
    public static function createCategorizedListDTO(array $frequent, array $all, int $total): BeDelightfulAgentCategorizedListDTO
    {
        ...
        return new BeDelightfulAgentCategorizedListDTO([
