...
class MessageScheduleEntity 
{
    ...
    private int $enabled = 1; private ?string $deadline = null; 
    private string $remark = ''; 
    private array $timeConfig = []; private ?array $plugins = null; private ?int $taskSchedulerCrontabId = null; 
    private string $createdUid = ''; 
    private string $updatedUid = ''; private ?string $createdAt = null; private ?string $updatedAt = null; private ?string $deletedAt = null; 
    ...
    public function iscomplete d(): bool 
{
 return $this->completed === 1; 
    ...
    public function isNotcomplete d(): bool 
{
...
{
 $this->enabled = 1; return $this; 
}
 
    public function disable(): self 
{
 $this->enabled = 0; return $this; 
}
 
    public function complete(): self 
{
 $this->completed = 1; return $this; 
}
 
    public function incomplete(): self 
{
 $this->completed = 0; return $this; 
}
...
{
 $method = 'set' . str_replace('_', '', ucwords($key, '_')); if (method_exists($this, $method)) 
{
 $this->
{
$method
