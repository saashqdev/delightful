...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    public static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'document_file.name.max' => 'documentnamelengthnot能超过255character',
            'document_file.key.required' => 'document键not能为空',
            'document_file.key.max' => 'document键lengthnot能超过255character',
            ...
            'fragment_config.normal.text_preprocess_rule.required_if' => 'text预processrulenot能为空',
            ...
            'fragment_config.normal.text_preprocess_rule.*.in' => '预processrulemust是 1(替换spaceetc) or 2(deleteURL和邮箱)',
            ...
            'fragment_config.parent_child.chunk_size.required_if' => 'textnot能为空',
            ...
            'fragment_config.parent_child.text_preprocess_rule.required_if' => 'text预processrulenot能为空',
            ...
            'fragment_config.parent_child.text_preprocess_rule.*.in' => '预processrulemust是 1(替换spaceetc) or 2(deleteURL和邮箱)',
        ];
    }
