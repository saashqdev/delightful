...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    public static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'fragment_config.mode.in' => 'minutesegmentmodetypemustis 1(通usemodetype) or 2(parent-childminutesegment)',
            'fragment_config.normal.required_if' => '通usemodetypeconfigurationnotcanforempty',
            ...
            'fragment_config.parent_child.parent_mode.in' => 'parentpiecemodetypemustis 1(segment落) or 2(authority)',
