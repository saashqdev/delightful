...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    {
        return [
            'document_file.required' => 'documentfilenot能for空',
            'document_file.name.required' => 'documentnamenot能for空',
            'document_file.name.max' => 'documentnamelengthnot能超pass255character',
            'document_file.key.required' => 'document键not能for空',
            'document_file.key.max' => 'document键lengthnot能超pass255character',
            'fragment_config.required' => 'slicesegmentconfigurationnot能for空',
            'fragment_config.mode.required' => 'minutesegment模typenot能for空',
            'fragment_config.mode.integer' => 'minutesegment模typemustis整数',
            'fragment_config.mode.in' => 'minutesegment模typemustis 1(通use模type) or 2(父子minutesegment)',
            'fragment_config.normal.required_if' => '通use模typeconfigurationnot能for空',
            'fragment_config.normal.text_preprocess_rule.required_if' => 'text预processrulenot能for空',
            'fragment_config.normal.text_preprocess_rule.*.required' => '预processruleitemnot能for空',
            'fragment_config.normal.text_preprocess_rule.*.integer' => '预processrulemustis整数',
            'fragment_config.normal.text_preprocess_rule.*.in' => '预processrulemustis 1(替换spaceetc) or 2(deleteURLand邮箱)',
            'fragment_config.normal.segment_rule.required_if' => 'minutesegmentrulenot能for空',
            'fragment_config.normal.segment_rule.separator.required_if' => 'minutesegmentidentifiernot能for空',
            'fragment_config.normal.segment_rule.chunk_size.required_if' => 'most大minutesegmentlengthnot能for空',
            'fragment_config.normal.segment_rule.chunk_size.min' => 'most大minutesegmentlengthmustgreater than0',
            'fragment_config.normal.segment_rule.chunk_overlap.required_if' => 'minutesegment重叠lengthnot能for空',
            'fragment_config.normal.segment_rule.chunk_overlap.min' => 'minutesegment重叠lengthmustgreater thanequal0',
            'fragment_config.parent_child.required_if' => '父子minutesegmentconfigurationnot能for空',
            'fragment_config.parent_child.separator.required_if' => 'minutesegmentidentifiernot能for空',
            'fragment_config.parent_child.chunk_size.required_if' => 'textnot能for空',
            'fragment_config.parent_child.parent_mode.required_if' => '父piece模typenot能for空',
            'fragment_config.parent_child.parent_mode.in' => '父piece模typemustis 1(segment落) or 2(权威)',
            'fragment_config.parent_child.child_segment_rule.required_if' => '子pieceminutesegmentrulenot能for空',
            'fragment_config.parent_child.child_segment_rule.separator.required_if' => '子pieceminutesegmentidentifiernot能for空',
            'fragment_config.parent_child.child_segment_rule.chunk_size.required_if' => '子piecemost大minutesegmentlengthnot能for空',
            'fragment_config.parent_child.child_segment_rule.chunk_size.min' => '子piecemost大minutesegmentlengthmustgreater than0',
            'fragment_config.parent_child.parent_segment_rule.required_if' => '父pieceminutesegmentrulenot能for空',
            'fragment_config.parent_child.parent_segment_rule.separator.required_if' => '父pieceminutesegmentidentifiernot能for空',
            'fragment_config.parent_child.parent_segment_rule.chunk_size.required_if' => '父piecemost大minutesegmentlengthnot能for空',
            'fragment_config.parent_child.parent_segment_rule.chunk_size.min' => '父piecemost大minutesegmentlengthmustgreater than0',
            'fragment_config.parent_child.text_preprocess_rule.required_if' => 'text预processrulenot能for空',
            'fragment_config.parent_child.text_preprocess_rule.*.required' => '预processruleitemnot能for空',
            'fragment_config.parent_child.text_preprocess_rule.*.integer' => '预processrulemustis整数',
