...
class TaskFileEntity extends AbstractEntity 
{
    ...
    protected int $fileSize = 0; protected ?string $externalUrl = ''; 
    protected StorageType $storageType; 
    protected bool $isHidden = false; 
    protected bool $isDirectory = false; 
    protected int $sort = 0; protected ?int $parentId = null; protected ?string $metadata = null; 
    protected TaskFileSource $source; 
    protected string $createdAt = ''; 
    protected string $updatedAt = ''; protected ?string $deletedAt = null; protected ?int $latestModifiedTopicId = null; protected ?int $latestModifiedTaskId = null; 
...
{
 return [ 'file_id' => $this->fileId, 'user_id' => $this->userId, 'organization_code' => $this->organizationCode, 'project_id' => $this->projectId, 'topic_id' => $this->topicId, 'task_id' => $this->taskId, 'file_type' => $this->fileType, 'file_name' => $this->fileName, 'file_extension' => $this->fileExtension, 'file_key' => $this->fileKey, 'file_size' => $this->fileSize, 'external_url' => $this->externalUrl, 'storage_type' => $this->storageType->value, 'is_hidden' => $this->isHidden, 'is_directory' => $this->isDirectory, 'sort' => $this->sort, 'parent_id' => $this->parentId, 'metadata' => $this->metadata, 'source' => $this->source->value, 'created_at' => $this->createdAt, 'updated_at' => $this->updatedAt, 'deleted_at' => $this->deletedAt, 'latest_modified_topic_id' => $this->latestModifiedTopicId, 'latest_modified_task_id' => $this->latestModifiedTaskId, ]; 
}
