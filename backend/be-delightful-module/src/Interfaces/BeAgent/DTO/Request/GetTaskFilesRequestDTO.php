...
{
 $this->id = isset($params['id']) ? (int) $params['id'] : 0; $this->page = isset($params['page']) ? (int) $params['page'] : 1; $this->pageSize = isset($params['page_size']) ? (int) $params['page_size'] : 20; $this->validate(); 
}
