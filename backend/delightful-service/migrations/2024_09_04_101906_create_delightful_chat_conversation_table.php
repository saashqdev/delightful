...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_chat_conversations', static function (Blueprint $table) {
            ...
            // whether置顶
            $table->tinyInteger('is_top')->default(0)->comment('whether置顶 0否 1是');
            // whethermark
            ...
            $table->comment('user的sessionlist。session可能是private chat、group chat、系统message、一个云documentor者多维table格etc。');
        });
    }
