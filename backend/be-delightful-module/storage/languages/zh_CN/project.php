...
return [
    ...
    'cannot_set_shortcut_for_own_project' => 'Cannot set shortcut for own project',
    'project_id_required_for_collaboration' => 'Creating scheduled task in collaboration space requires selecting a project',
    'not_a_collaboration_project' => 'You do not have permission to access this collaboration project, please contact project administrator',
    ...
    // Team collaboration error messages
    ...
    'batch_permission_updated' => 'Batch permission settings updated successfully',
