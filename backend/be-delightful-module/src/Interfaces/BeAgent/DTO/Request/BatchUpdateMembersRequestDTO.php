...
/** * BatchUpdateMemberpermission RequestDTO. * * BatchUpdateMemberpermission RequestParameterValidate * InheritanceAbstractRequestDTOautomatic SupportParameterValidate TypeConvert */

class BatchUpdateMembersRequestDTO extends AbstractRequestDTO 
{
 /** @var array Memberpermission UpdateDatalist */ 
...
{
 return [ 'members' => 'required|array|min:1|max:500', 'members.*.target_type' => 'required|string|in:user ,Department', 'members.*.target_id' => 'required|string|max:128', 'members.*.role' => 'required|string|in:viewer,editor,manage', ]; 
}
