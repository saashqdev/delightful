...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_contact_accounts', static function (Blueprint $table) {
            ...
            $table->string('delightful_id', 64)->comment('账numberid,跨租户(organization)唯one. foravoidanduser_id(organizationinside唯one)概念混淆,thereforeup名delightful_id')->default('');
            // 账numbertype
