...
class InitSandboxResponseDTO 
{
    ...
    protected string $sandboxId = ''; /** * Function. */ 
...
{
 return [ 'task_id' => $this->taskId, 'workspace_id' => $this->workspaceId, 'project_id' => $this->projectId, 'project_mode' => $this->projectMode, 'topic_id' => $this->topicId, 'sandbox_id' => $this->sandboxId, ]; 
}
