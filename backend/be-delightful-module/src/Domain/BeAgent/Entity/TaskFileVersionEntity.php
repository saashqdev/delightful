...
class TaskFileVersionEntity extends AbstractEntity 
{
    ...
    protected string $updatedAt = ''; protected ?string $deletedAt = null; 
...
{
 return [ 'id' => $this->id, 'file_id' => $this->fileId, 'organization_code' => $this->organizationCode, 'file_key' => $this->fileKey, 'version' => $this->version, 'edit_type' => $this->editType, 'created_at' => $this->createdAt, 'updated_at' => $this->updatedAt, 'deleted_at' => $this->deletedAt, ]; 
}
