...
/**
 * Update project members request DTO.
 *
 * Encapsulates request parameters and validation logic for updating project members
...
{
    /** @var string Project ID (from route parameter) */
