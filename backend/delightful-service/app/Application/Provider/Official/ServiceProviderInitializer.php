    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => '字section跳动旗down云service平台，havefrom主研hair豆package大model系column。涵盖豆package通usemodel Pro、lite，具备differenttexthandleand综合能力，alsohaverole扮演、voice合becomeetc多typemodel。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '字section跳动旗down云service平台，havefrom主研hair豆package大model系column。涵盖豆package通usemodel Pro、lite，具备differenttexthandleand综合能力，alsohaverole扮演、voice合becomeetc多typemodel。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => '火山engine',
                'provider_code' => 'Volcengine',
                'description' => '提供多type智能绘graph大model，生graphstyle多样，securityproperty极高，can亠泛application干教育、娱乐、办公etc场quantity。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供多type智能绘graph大model，生graphstyle多样，securityproperty极高，can亠泛application干教育、娱乐、办公etc场quantity。',
                    ],
                ]),
                'remark' => '',
            ],
