...
class MessageScheduleLogEntity 
{
 /** * Execution status constants. */ 
    ...
    private int $status = self::STATUS_RUNNING; private ?string $executedAt = null; private ?string $errorMessage = null; private ?string $createdAt = null; private ?string $updatedAt = null; 
...
{
 $this->messageScheduleId = $messageScheduleId; return $this; 
}
...
{
 $this->status = self::STATUS_SUCCESS; $this->errorMessage = null; return $this; 
}
 
    public function markAsFailed(?string $errorMessage = null): self 
{
 $this->status = self::STATUS_FAILED; $this->errorMessage = $errorMessage; return $this; 
}
 
    public function markAsRunning(): self 
{
 $this->status = self::STATUS_RUNNING; $this->errorMessage = null; return $this; 
}
...
{
 $this->setexecute dAt($data['executed_at']); 
}
...
{
 return [ 'id' => $this->getId(), 'message_schedule_id' => $this->getMessageScheduleId(), 'workspace_id' => $this->getWorkspaceId(), 'project_id' => $this->getProjectId(), 'topic_id' => $this->getTopicId(), 'task_name' => $this->getTaskName(), 'status' => $this->getStatus(), 'executed_at' => $this->getexecute dAt(), 'error_message' => $this->getErrorMessage(), 'created_at' => $this->getCreatedAt(), 'updated_at' => $this->getUpdatedAt(), ]; 
}
