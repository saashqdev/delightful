...
class DelightfulMessageEntity extends AbstractEntity
{
    ...
    /**
     * send方type. user:user(aialsobe认forisuser),group:group chat,system:systemmessage,cloud_document:云document,multidimensional_table:多维table格 topic:topic app:applicationmessage.
     */
    ...
    /**
     * receiveobjecttype. user:user(aialsobe认forisuser),group:group chat,system:systemmessage,cloud_document:云document,multidimensional_table:多维table格 topic:topic app:applicationmessage.
     * @see UserType
     */
