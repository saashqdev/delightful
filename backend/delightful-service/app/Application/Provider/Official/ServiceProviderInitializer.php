    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'Azure 提供多种先进的AImodel、includeGPT-3.5和mostnewGPT-4系列、support多种datatype和复杂task，致力atsecurity、可靠和可持续的AIresolvesolution,',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Azure 提供多种先进的AImodel、includeGPT-3.5和mostnewGPT-4系列、support多种datatype和复杂task，致力atsecurity、可靠和可持续的AIresolvesolution,',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '字节跳动旗下的云service平台，have自主研发的豆package大model系列。涵盖豆package通usemodel Pro、lite，具备different文本handle和综合能力，alsohaverole扮演、voice合成etc多种model。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '字节跳动旗下的云service平台，have自主研发的豆package大model系列。涵盖豆package通usemodel Pro、lite，具备different文本handle和综合能力，alsohaverole扮演、voice合成etc多种model。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => '火山engine',
                'provider_code' => 'Volcengine',
                'description' => '提供多种智能绘图大model，生图style多样，security性极高，可亠泛application干教育、娱乐、办公etc场量。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供多种智能绘图大model，生图style多样，security性极高，可亠泛application干教育、娱乐、办公etc场量。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '专注at人脸技术、人体技术、图像识别、图像handle、图像generateetc核心领域',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '专注at人脸技术、人体技术、图像识别、图像handle、图像generateetc核心领域',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Delightful',
                'provider_code' => 'Official',
                'description' => '由 Delightful pass官方deploy的 API 来implement多种热门的文生图、图生图etcmodel的call，可直接购买pointsuse海量的大model。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/delightful.png',
                'provider_type' => 1, // Official
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '由 Delightful pass官方deploy的 API 来implement多种热门的文生图、图生图etcmodel的call，可直接购买pointsuse海量的大model。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'TTAPI.io',
                'provider_code' => 'TTAPI',
                'description' => '整合多平台文生图、文生video能力，Midjourney API、DALL·E 3、Luma文生video、Flux APIserviceetcetc。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '整合多平台文生图、文生video能力，Midjourney API、DALL·E 3、Luma文生video、Flux APIserviceetcetc。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'Amazon Bedrock 是亚马逊 AWS 提供的一项service，专注at为企业提供先进的 AI 语言model和视觉model。其model家族include Anthropic 的 Claude 系列、Meta 的 Llama 3.1 系列etc，涵盖from轻量级to高performance的多种选择，support文本generate、conversation、图像handleetc多种task，适useatdifferent规模和需求的企业application。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Amazon Bedrock 是亚马逊 AWS 提供的一项service，专注at为企业提供先进的 AI 语言model和视觉model。其model家族include Anthropic 的 Claude 系列、Meta 的 Llama 3.1 系列etc，涵盖from轻量级to高performance的多种选择，support文本generate、conversation、图像handleetc多种task，适useatdifferent规模和需求的企业application。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Microsoft Azure',
                'provider_code' => 'MicrosoftAzure',
                'description' => '提供多种先进的AImodel、includeGPT-3.5和mostnewGPT-4系列、support多种datatype和复杂task，致力atsecurity、可靠和可持续的AIresolvesolution。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/azure Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => '提供通use图像generatemodel，support多种艺术style，particularly擅长复杂文本渲染，especially是中英文文本渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供通use图像generatemodel，support多种艺术style，particularly擅长复杂文本渲染，especially是中英文文本渲染。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '提供 Gemini 2.5 Flash Image (Nano Banana) 图像generatemodel，具备role一致性高、精准图像editetc。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供 Gemini 2.5 Flash Image (Nano Banana) 图像generatemodel，具备role一致性高、精准图像editetc。',
                    ],
                ]),
                'remark' => '',
            ],
