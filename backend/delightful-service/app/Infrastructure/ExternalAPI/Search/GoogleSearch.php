...
class GoogleSearch
{
    ...
    private const int REFERENCE_COUNT = 8; // replacefor你needquotequantity
    ...
    public function search(
        ...
        try {
            ...
            $this->logger->error(sprintf(
                '谷歌search遇toerror:%s,file:%s,line:%s trace:%s, will generate again.',
            ...
            $this->logger->error('谷歌search遇toerror:' . $e->getMessage());
        }
        return [];
    }
}
