...
## 背景说明
user提交了一段录音内容，录音内容经过语音识别转为文字，user可能还会提供手写的笔记作为补充说明。现在需要你根据这些内容generate一个简洁准确的标题。
...
## 背景说明
user上传了一个音频文件到系统中，并在聊天框中send了总结请求。现在需要你根据user的请求message（其中contain文件名），为这次录音总结generate一个简洁准确的标题。
...
2. **智能判断**：
   - 如果文件名语义清晰（如"2024年Q4产品规划会议.mp3"、"客户需求讨论.wav"），优先基于文件名generate标题
