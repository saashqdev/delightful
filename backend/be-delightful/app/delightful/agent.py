    ...
    async def _process_tool_call_results(self, tool_call_results: List[ToolResult]) -> tuple[bool, Optional[str]]:
        ...
        for result in tool_call_results:
            ...
            try:
                ...
                elif result.name == "call_agent" and self.agent_name == "be-delightful":
                    logger.info("Detected be-delightful agent performed call_agent tool call, will append task confirmation reminder message")
                    await self.chat_history.append_assistant_message(
