...
JSON, true));
        ...
        $executionData->saveNodeContext('9527', [
            ...
            'user_prompt' => 'helpIextractonedown https://example.tos-cn-beijing.volces.com/DELIGHTFUL/test/out師table.txt and https://example.tos-cn-beijing.volces.com/DELIGHTFUL/test/test.csv content',
        ]);
