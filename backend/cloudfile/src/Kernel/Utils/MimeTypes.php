...
/**
 * Excerpted from: \Symfony\Component\Mime\MimeTypes.
 */
final class MimeTypes
{
    ...
    private const MAP = [
        ...
        'application/x-m4' => ['m4'],
        'application/x-delightfulpoint' => ['mgp'],
    ...
    private const REVERSE_MAP = [
        ...
        'mgp' => ['application/vnd.osgeo.mapguide.package', 'application/x-delightfulpoint'],
