...
JSON, true));
        ...
        $executionData->saveNodeContext('9527', [
            ...
            'user_prompt' => 'I想thissegmenttextsplitonedown:late emperorentrepreneurshipnothalfwhilemiddle道崩殂,todaydaydownthreeminute,Yizhou exhausted,thisindeed critical momentalso.loyal guard ministersnot懈atinside,忠志of士忘bodyatoutsideperson,盖追late emperorof殊遇,欲报ofat陛downalso.誠宜open张聖聽,by光late emperorlegacy virtue,expand志士spirit,not宜妄frommeager,import喻失义,by塞忠諫of路also.
...
亲贤臣,远smallperson,thisfirst漢 byprosperousalso;亲smallperson,遠賢臣,thisback汉 by倾颓also.late emperorino clock,eachandminister discussionthisthing,not尝notsigh with regretat桓,灵also.侍middle,尚book,long史,join army,this悉贞良deadsectionministers,wishdowntrust them,then漢室of隆,can计daywhilependingalso.
