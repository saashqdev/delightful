...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_contact_third_platform_id_mapping', static function (Blueprint $table) {
            ...
            // 映射type：user id、department id、null间 id，organizationencoding
            ...
            // delightful 体系的organizationencoding
            $table->string('delightful_organization_code', 32)->comment('delightful 体系的organizationencoding');
            $table->timestamps();
            $table->softDeletes();
            ...
            $table->comment('department、user、null间encoding等的映射关系record');
        });
    }
