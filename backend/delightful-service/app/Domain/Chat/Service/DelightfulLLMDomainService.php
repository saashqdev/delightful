...
class DelightfulLLMDomainService
{
    ...
    - ifreturnanswerverylong,please盡quantitystructureization,minutesegmentfallsummary.ifneedminutepointasanswer,尽quantitycontrolin5pointbyinside,andmergerelatedclosecontent.
