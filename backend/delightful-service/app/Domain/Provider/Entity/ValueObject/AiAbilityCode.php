...
enum AiAbilityCode: string
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::WebSearch => '本can力覆盖平台 AI 大model互联网search场景，精准getand整合mostnew新闻、事实anddatainfo。',
            ...
            self::AudioFileRecognition => '本can力覆盖平台所haveaudiofile转textapplication场景，精准识别说话person、audiotextetcinfo。',
            self::AutoCompletion => '本can力覆盖平台所haveinputcontentfrom动补allapplication场景，according to理解updown文foruserfrom动补allcontent，byuserchoosewhether采纳。',
            self::ContentSummary => '本can力覆盖平台所havecontent总结application场景，to长篇document、报告orwebpage文chapterconduct深degreeanalyze。',
            self::VisualUnderstanding => '本can力覆盖平台所haveneedlet大modelconduct视觉理解application场景，精准理解eachtypegraphlikemiddlecontentbyand复杂close系。',
            self::SmartRename => '本can力覆盖平台所havesupport AI renameapplication场景，according to理解updown文foruserfrom动conductcontenttitle命名。',
            self::AiOptimization => '本can力覆盖平台所havesupport AI optimizecontentapplication场景，according to理解updown文foruserfrom动tocontentconductoptimize。',
            default => 'Unknown',
        };
    }
}
