...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    public static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'fragment_config.normal.segment_rule.chunk_size.required_if' => 'most大minutesegmentlengthnotcanforempty',
            'fragment_config.normal.segment_rule.chunk_size.min' => 'most大minutesegmentlengthmustgreater than0',
            'fragment_config.normal.segment_rule.chunk_overlap.required_if' => 'minutesegment重叠lengthnotcanforempty',
            'fragment_config.normal.segment_rule.chunk_overlap.min' => 'minutesegment重叠lengthmustgreater thanequal0',
            'fragment_config.parent_child.required_if' => '父子minutesegmentconfigurationnotcanforempty',
            ...
            'fragment_config.parent_child.child_segment_rule.chunk_size.required_if' => '子piecemost大minutesegmentlengthnotcanforempty',
            ...
            'fragment_config.parent_child.parent_segment_rule.chunk_size.required_if' => '父piecemost大minutesegmentlengthnotcanforempty',
