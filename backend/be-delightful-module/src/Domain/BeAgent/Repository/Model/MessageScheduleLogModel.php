...
class MessageScheduleLogModel extends AbstractModel 
{
 /** * Execution status constants. */ 
    ...
    public 
    const STATUS_RUNNING = 3; /** * table name. */ protected ?string $table = 'magic_super_agent_message_schedule_log'; /** * Fillable fields. */ 
    protected array $fillable = [ 'id', 'message_schedule_id', 'workspace_id', 'project_id', 'topic_id', 'task_name', 'status', 'executed_at', 'error_message', ]; /** * Get the message schedule that owns this log. */ 
