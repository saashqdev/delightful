...
![Main Process](https://cdn.bedelightful.ai/static/img/flow1.png)
...
![Task Breakdown Flow](https://cdn.bedelightful.ai/static/img/flow2.png)

   2. Choose GPT4o as the model for task breakdown

![Choose Model](https://cdn.bedelightful.ai/static/img/flow3.png)

3. Build a task execution process and load the appropriate tools
   1. Create a task execution flow

![Task Execution Flow](https://cdn.bedelightful.ai/static/img/flow4.png)

   2. Load the tools needed for task execution

![Load Tools](https://cdn.bedelightful.ai/static/img/flow5.png)

4. Observe and verify the results

![Verify Results](https://cdn.bedelightful.ai/static/img/flow5.png) 