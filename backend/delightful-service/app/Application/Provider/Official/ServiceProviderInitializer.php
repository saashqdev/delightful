    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => 'Azure 提供多type先enterAImodel、includeGPT-3.5andmostnewGPT-4系column、support多typedatatypeand复杂task，致力atsecurity、can靠andcancontinueAIresolvesolution,',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Azure 提供多type先enterAImodel、includeGPT-3.5andmostnewGPT-4系column、support多typedatatypeand复杂task，致力atsecurity、can靠andcancontinueAIresolvesolution,',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => '火山engine',
                'provider_code' => 'Volcengine',
                'description' => '提供多type智can绘graph大model，生graphstyle多样，securityproperty极高，can亠泛application干教育、娱乐、办公etc场quantity。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供多type智can绘graph大model，生graphstyle多样，securityproperty极高，can亠泛application干教育、娱乐、办公etc场quantity。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '专注atperson脸技术、personbody技术、graphlike识别、graphlikehandle、graphlikegenerateetc核core领域',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '专注atperson脸技术、personbody技术、graphlike识别、graphlikehandle、graphlikegenerateetc核core领域',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Microsoft Azure',
                'provider_code' => 'MicrosoftAzure',
                'description' => '提供多type先enterAImodel、includeGPT-3.5andmostnewGPT-4系column、support多typedatatypeand复杂task，致力atsecurity、can靠andcancontinueAIresolvesolution。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/azure Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => '提供通usegraphlikegeneratemodel，support多type艺术style，particularly擅长复杂text渲染，especiallyismiddleEnglishtext渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供通usegraphlikegeneratemodel，support多type艺术style，particularly擅长复杂text渲染，especiallyismiddleEnglishtext渲染。',
                    ],
                ]),
                'remark' => '',
            ],
