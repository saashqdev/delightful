...
# not如decrease \Hyperf\Snowflake\Configuration middle $dataCenterIdBits and $workerIdBits size,增大 $sequenceBits,by便单台机器each毫second能generatemore多雪flowerid,decrease特高andhairdownetc待time
return [
