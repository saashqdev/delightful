...
class ProjectOperationLogEntity extends AbstractEntity 
{
 /** * @var int primary key ID */ 
    protected int $id = 0; /** * @var int Project ID */ 
    protected int $projectId = 0; /** * @var string user ID */ 
    protected string $userId = ''; /** * @var string organization code */ 
    protected string $organizationCode = ''; /** * @var string */ 
    protected string $operationAction = ''; /** * @var string ResourceType */ 
    protected string $resourceType = ''; /** * @var string ResourceID */ 
    protected string $resourceId = ''; /** * @var string ResourceName */ 
    protected string $resourceName = ''; /** * @var array Details */ 
    protected array $operationDetails = []; /** * @var string Status */ 
    protected string $operationStatus = 'success'; /** * @var null|string IPAddress */ protected ?string $ipAddress = null; /** * @var string Creation time */ 
    protected string $createdAt = ''; /** * @var string Update time */ 
...
{
 $this->operationAction = $operationAction; return $this; 
}
...
{
 $this->operationDetails = $operationDetails; return $this; 
}
...
{
 $this->operationStatus = $operationStatus; return $this; 
}
