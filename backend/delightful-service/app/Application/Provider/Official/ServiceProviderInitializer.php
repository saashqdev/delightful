    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'name' => '火山引擎',
                'provider_code' => 'Volcengine',
                'description' => '提供多种智能绘图大model，生图风格多样，安全性极高，可亠泛application干教育、娱乐、办公等场量。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供多种智能绘图大model，生图风格多样，安全性极高，可亠泛application干教育、娱乐、办公等场量。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => '提供通用图像generatemodel，支持多种艺术风格，尤其擅长复杂文本渲染，特别是中英文文本渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供通用图像generatemodel，支持多种艺术风格，尤其擅长复杂文本渲染，特别是中英文文本渲染。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '提供 Gemini 2.5 Flash Image (Nano Banana) 图像generatemodel，具备role一致性高、精准图像edit等。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供 Gemini 2.5 Flash Image (Nano Banana) 图像generatemodel，具备role一致性高、精准图像edit等。',
                    ],
                ]),
                'remark' => '',
            ],
