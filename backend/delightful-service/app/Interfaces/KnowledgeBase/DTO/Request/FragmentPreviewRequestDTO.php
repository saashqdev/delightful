...
class FragmentPreviewRequestDTO extends AbstractRequestDTO
{
    ...
    public static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'fragment_config.normal.text_preprocess_rule.*.in' => '预处理规则必须是 1(替换空格等) 或 2(deleteURL和邮箱)',
            ...
            'fragment_config.parent_child.text_preprocess_rule.*.in' => '预处理规则必须是 1(替换空格等) 或 2(deleteURL和邮箱)',
        ];
    }
