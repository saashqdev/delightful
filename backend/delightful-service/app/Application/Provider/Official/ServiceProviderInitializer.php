    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'description' => '由 Delightful pass官方部署的 API 来implement AI 模型的call，可直接购买积分use海量的大模型。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '由 Delightful pass官方部署的 API 来implement AI 模型的call，可直接购买积分use海量的大模型。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => 'Azure 提供多种先进的AI模型、includeGPT-3.5和最newGPT-4系列、支持多种数据type和复杂task，致力于安全、可靠和可持续的AIresolve方案,',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Azure 提供多种先进的AI模型、includeGPT-3.5和最newGPT-4系列、支持多种数据type和复杂task，致力于安全、可靠和可持续的AIresolve方案,',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '字节跳动旗下的云服务平台，有自主研发的豆包大模型系列。涵盖豆包通用模型 Pro、lite，具备different文本handle和综合能力，还有role扮演、voice合成等多种模型。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '字节跳动旗下的云服务平台，有自主研发的豆包大模型系列。涵盖豆包通用模型 Pro、lite，具备different文本handle和综合能力，还有role扮演、voice合成等多种模型。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => '火山引擎',
                'provider_code' => 'Volcengine',
                'description' => '提供多种智能绘图大模型，生图风格多样，安全性极高，可亠泛application干教育、娱乐、办公等场量。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/volcengine Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供多种智能绘图大模型，生图风格多样，安全性极高，可亠泛application干教育、娱乐、办公等场量。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '专注于人脸技术、人体技术、图像识别、图像handle、图像generate等核心领域',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '专注于人脸技术、人体技术、图像识别、图像handle、图像generate等核心领域',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Delightful',
                'provider_code' => 'Official',
                'description' => '由 Delightful pass官方部署的 API 来implement多种热门的文生图、图生图等模型的call，可直接购买积分use海量的大模型。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/delightful.png',
                'provider_type' => 1, // Official
                'category' => 'vlm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '由 Delightful pass官方部署的 API 来implement多种热门的文生图、图生图等模型的call，可直接购买积分use海量的大模型。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'description' => '请use接口与 OpenAI API same形式的服务商',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '请use接口与 OpenAI API same形式的服务商',
                    ],
                ]),
            ...
            [
                ...
                'description' => 'Amazon Bedrock 是亚马逊 AWS 提供的一项服务，专注于为企业提供先进的 AI 语言模型和视觉模型。其模型家族include Anthropic 的 Claude 系列、Meta 的 Llama 3.1 系列等，涵盖从轻量级到高performance的多种选择，支持文本generate、conversation、图像handle等多种task，适用于different规模和需求的企业application。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => 'Amazon Bedrock 是亚马逊 AWS 提供的一项服务，专注于为企业提供先进的 AI 语言模型和视觉模型。其模型家族include Anthropic 的 Claude 系列、Meta 的 Llama 3.1 系列等，涵盖从轻量级到高performance的多种选择，支持文本generate、conversation、图像handle等多种task，适用于different规模和需求的企业application。',
                    ],
                ]),
                'remark' => '',
            ],
            ...
            [
                ...
                'name' => 'Microsoft Azure',
                'provider_code' => 'MicrosoftAzure',
                'description' => '提供多种先进的AI模型、includeGPT-3.5和最newGPT-4系列、支持多种数据type和复杂task，致力于安全、可靠和可持续的AIresolve方案。',
                'icon' => 'DELIGHTFUL/713471849556451329/default/azure Avatars.png',
                'provider_type' => 0,
                'category' => 'vlm',
                'status' => 1,
            ...
            [
                ...
                'name' => 'Qwen',
                'provider_code' => 'Qwen',
                'description' => '提供通用图像generate模型，支持多种艺术风格，尤其擅长复杂文本渲染，特别是中英文文本渲染。',
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        ...
                        'zh_CN' => '提供通用图像generate模型，支持多种艺术风格，尤其擅长复杂文本渲染，特别是中英文文本渲染。',
                    ],
                ]),
                'remark' => '',
            ],
