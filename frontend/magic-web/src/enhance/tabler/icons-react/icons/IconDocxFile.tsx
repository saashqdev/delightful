...
function IconDocxFile({ size }: IconProps) {
	return (
		<svg
			width={size}
			height={size}
		...
		>
			<g clip-path="url(#clip0_171_244072)">
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
				...
				/>
				<path
					d="M7.67999 10.843V18.554L12.5 13.736L17.32 18.554V10.844"
					stroke="white"
					stroke-width="1.5"
...
export default memo(IconDocxFile)
