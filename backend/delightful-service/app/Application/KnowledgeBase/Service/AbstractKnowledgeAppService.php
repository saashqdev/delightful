...
abstract class AbstractKnowledgeAppService extends AbstractKernelAppService
{
    ...
    protected function checkKnowledgeBaseOperation(
        ...
        // if传slicesegmentid,thengetdocumenttoshouldknowledge basecodeanddocumentcode,andconductvalidation
        if ($fragmentId) {
        ...
        // if传documentcode,thengetdocumenttoshouldknowledge basecode,andconductvalidation
        if ($documentCode) {
