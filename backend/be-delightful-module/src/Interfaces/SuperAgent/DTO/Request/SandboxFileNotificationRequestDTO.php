...
class SandboxFileNotificationRequestDTO extends AbstractRequestDTO
{
    ...
    protected static function getHyperfValidationRules(): array
    {
        return [
            ...
            'metadata.super_delightful_task_id' => 'required|string',
    ...
    protected static function getHyperfValidationMessage(): array
    {
        return [
            ...
            'metadata.super_delightful_task_id.required' => 'Task ID in metadata cannot be empty',
            'metadata.super_delightful_task_id.string' => 'Task ID must be a string',
