...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('delightful_api_premium_exceptions', function (Blueprint $table) {
            ...
            $table->integer('retry_max_times')->comment('retry最大次数')->nullable();
            $table->integer('retry_interval')->comment('retry时间间隔')->nullable();
            $table->datetimes();
            $table->comment('exceptioninformation表，储存exceptiontype，是否canretry，retry最大次数，retry时间间隔');
        });
    }
